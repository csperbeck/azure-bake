...
exports.pluginNS = "@azbake/ingredient-api-management-api" //name of the ingredient to reference in a bake.yaml recipe

/* comment out these entries if you are not including a set of expression functions*/
exports.functions = ApimApiUtils
exports.functionsNS = "apim-api" //bake.yaml expressions can access your functions via "myutils.my_function()"